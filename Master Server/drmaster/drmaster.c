...
int maxservers=0;
int MaxServerAge = 120; //Servers are removed after 120 seconds of inactivity




char header1[3000] = {"
<HTML><HEAD><TITLE>DerangedRaid Server List</TITLE><ALKALINE skip>
<META content=\"A list of all active DerangedRaid multiplayer servers\" 
name=description>
<LINK href=\"drmaster.css\" rel=stylesheet type=text/css></ALKALINE>
...
char header3[3000] = {"
	   ...
	   <BR><BR>
		...
		&nbsp; Server Name
                ...
                <TD width=60 align=middle borderColor=#c0c0c0><FONT face=Tahoma size=1><B>
		Players
		</B></FONT></TD>
                <TD width=60 align=middle borderColor=#c0c0c0><FONT face=Tahoma size=1><B>
		Maximum
...
if (f=fopen("//home//httpd//html//draid//drmaster.html", "w"))
{
